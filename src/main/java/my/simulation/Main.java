...
public class Main {
    public static void main(String[] args) {
        Archer archer1 = new Archer("Archer", 5, 6, 100, 15, 0, 25, 1,1);
        Knight knight1 = new Knight("Knight", 7, 6, 200, 20, 0, 25, 1,1);
        Dragon dragon1 = new Dragon("Dragon", 3, 2, 150, 20, 0, 30, 1,1);
